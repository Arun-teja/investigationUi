		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comprprApprover-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprprApprover-display": {
								"semanticObject": "comprprApprover",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pr.prApprover",
									"url": sap.ui.require.toUrl("com/pr/prApprover")
								}
							}
						}
					}
