		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Investigation",
									"targetURL": "#comprprInvestigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprprInvestigation-display": {
								"semanticObject": "comprprInvestigation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pr.prInvestigation",
									"url": sap.ui.require.toUrl("com/pr/prInvestigation")
								}
							}
						}
					}
